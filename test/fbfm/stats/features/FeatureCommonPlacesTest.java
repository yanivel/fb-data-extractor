 ...
 */
public class FeatureCommonPlacesTest {
    
    public FeatureCommonPlacesTest() {
    }
    ...
    /**
     * Test of calculateStat method, of class FeatureCommonPlaces.
     */
    @Test
    public void testCalculateStat() throws StatException, BadParameterException {
        ...
        FeatureCommonPlaces instance = new FeatureCommonPlaces();
