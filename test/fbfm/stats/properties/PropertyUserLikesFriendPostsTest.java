 ...
 */
public class PropertyUserLikesFriendPostsTest {
    
    public PropertyUserLikesFriendPostsTest() {
    }
    ...
    /**
     * Test of calculateStat method, of class PropertyUserLikesFriendPosts.
     */
    @Test
    public void testCalculateStat() throws StatException, BadParameterException{
        ...
        PropertyUserLikesFriendPosts instance = new PropertyUserLikesFriendPosts();
