 ...
 */
public class PropertyUserTaggedFriendInPostTest {
    
    public PropertyUserTaggedFriendInPostTest() {
    }
    ...
    /**
     * Test of calculateStat method, of class PropertyUserTaggedFriendInPost.
     */
    @Test
    public void testCalculateStat() throws StatException, BadParameterException {
        ...
        String profileId = "100001531730648"; // valery sigal 
        FacebookClient facebookClient = new DefaultFacebookClient(accessToken);
        
        PropertyUserTaggedFriendInPost instance = new PropertyUserTaggedFriendInPost();
