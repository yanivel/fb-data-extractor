 ...
 */
public class PropertyFriendLikedMyPostsTest {
    
    public PropertyFriendLikedMyPostsTest() {
    }
    ...
    /**
     * Test of calculateStat method, of class PropertyFriendLikedMyPosts.
     */
    @Test
    public void testCalculateStat() throws StatException, BadParameterException {
        ...
        PropertyFriendLikedMyPosts instance = new PropertyFriendLikedMyPosts();
