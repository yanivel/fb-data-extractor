 ...
 */
public class PropertyFriendCommentedMyPostsTest {
    
    public PropertyFriendCommentedMyPostsTest() {
    }
    ...
    /**
     * Test of calculateStat method, of class PropertyFriendCommentedMyPosts.
     */
    @Test
    public void testCalculateStat() throws StatException, BadParameterException {
        ...
        String profileId = "100004551300688"; 
        FacebookClient facebookClient = new DefaultFacebookClient(accessToken);
        
        PropertyFriendCommentedMyPosts instance = new PropertyFriendCommentedMyPosts();
